...
class ProgressBar(bokeh_garden.application.AppWidget, bokeh.models.Plot):
	def __init__(self, app, **kw):
		...
		bokeh.models.Plot.__init__(self,
								   width=self._plot_width, height=50,
								   **kw)
		self.x_range = Range1d(0, 100, bounds=(0, 100))
		self.y_range = Range1d(0, 1, bounds=(0, 1))
		self._bar = self.hbar(y=0.5, right="x_values", height=2, left=0, color="#00779B", source=self._source,
							  level="underlay")
