...
class ProgressBar(bokeh_garden.application.AppWidget, bokeh.plotting.figure):
    def __init__(self, app, **kw):
        ...
        bokeh.plotting.figure.__init__(self,
                                       width=self._plot_width, height=50,
                                       **kw)
        self.x_range = Range1d(0, 100, bounds=(0, 100))
        self.y_range = Range1d(0, 1, bounds=(0, 1))
        self._bar = self.hbar(y=0.5, right="x_values", height=1, left=0, color="#00779B", source=self._source,
                              level="underlay")
...
class ProgressBars(bokeh_garden.application.AppWidget, bokeh.models.layouts.Column):
    def __init__(self, app, **kw):
        self._app = app
        bokeh.models.layouts.Column.__init__(self, sizing_mode="scale_both", **kw)
